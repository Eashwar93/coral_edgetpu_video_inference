...
int main(int argc, char** argv) {
	...
	edge::DetectionEngine engine(model_path,label_path,edgetpu_context,with_edgetpu);
	...
	while(true)
	{
		...
		edge::DetectionEngine::img_overlay(frame,detection_result,image_width,image_height);
